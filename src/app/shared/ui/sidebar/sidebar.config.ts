...
export const NAV_GROUPS: NavGroupData[] = [
  ...
  },
  {
    ...
    icon: 'store',
    items: [
      { id: 'distributors', title: 'Distribuidoras', icon: 'store', route: '/distribuidoras', roles: GG_AD_GS_CO_DI, permissions: ['distributors.view_any', 'distributors.view'], permissionMode: 'any' },
