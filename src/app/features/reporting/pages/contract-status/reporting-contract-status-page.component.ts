...
@Component({
  selector: 'mv-reporting-contract-status-page',
  ...
  template: `
    <article class="contract-page">
      ...
      <section aria-labelledby="available-heading">
        ...
        <p>
          Los siete endpoints de catálogo, definición, ejecución y seguimiento están integrados con
          sus rutas, parámetros e idempotencia documentados.
        </p>
      </section>
...
export class ReportingContractStatusPageComponent {
