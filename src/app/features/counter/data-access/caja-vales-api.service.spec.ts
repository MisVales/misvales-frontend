...
describe('CajaValesApiService', () => {
  ...
  it('captura los cambios al crear la solicitud', () => {
    service.requestModification('voucher-1', ['curp'], { curp: 'GODE561231HDFABC09' }, 'Corrección').subscribe();
  ...
  it('aplica la corrección con token y datos técnicos internos', () => {
