...
import { DistribuidorasApiService } from '../../../distributors/data-access/api/distribuidoras-api.service';
...
export class FiltrosClientesComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.distributors = distributors.datos.map((distributor) => ({
      id: distributor.id,
      numero: distributor.numero,
      nombreCompleto: distributor.nombreCompleto,
    }));
