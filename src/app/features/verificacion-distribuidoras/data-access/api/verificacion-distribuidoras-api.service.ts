...
export class VerificacionDistribuidorasApiService {
  ...
  listarSolicitudes(params?: {
    ...
    if (params?.perPage) httpParams = httpParams.set('por_pagina', params.perPage);
    if (params?.status) httpParams = httpParams.set('estado', params.status);
    if (params?.search) httpParams = httpParams.set('buscar', params.search);

    return this.http
      .get<{ data: SolicitudDistribuidoraResponseDto[]; meta: PaginationMeta }>(
  ...
  asignarVerificador(
    id: string,
    req: AsignarVerificadorRequestDto,
  ): Observable<SolicitudDistribuidoraResponseDto> {
    return this.http
      .post<{ data: SolicitudDistribuidoraResponseDto }>(
        `${this.apiUrl}/distributor-applications/${id}/assign-verifier`,
        req,
      )
      .pipe(map((res) => res.data));
  }
  ...
  listarVerificadoresDisponibles(
    ...
    return this.http
      .get<{
        data: { id: string; nombre_completo: string; sucursal_id: string; estado: string }[];
      }>(`${this.apiUrl}/distributor-applications/${solicitudId}/available-verifiers`)
      .pipe(map((res) => res.data));
  }
  ...
  listarVisitasAsignadas(params?: {
    ...
    return this.http
      .get<{ data: VisitaVerificacionResponseDto[]; meta?: PaginationMeta }>(
  ...
  actualizarVisita(
    id: string,
    req: ActualizarVisitaRequestDto,
  ): Observable<VisitaVerificacionResponseDto> {
    return this.http
      .put<{ data: VisitaVerificacionResponseDto }>(`${this.apiUrl}/verification-visits/${id}`, req)
      .pipe(map((res) => res.data));
  }

  finalizarVisita(
    id: string,
    req: FinalizarVisitaRequestDto,
  ): Observable<VisitaVerificacionResponseDto> {
    return this.http
      .post<{ data: VisitaVerificacionResponseDto }>(
        `${this.apiUrl}/verification-visits/${id}/finish`,
        req,
      )
      .pipe(map((res) => res.data));
  }
  ...
  adjuntarEvidencia(
    ...
    return this.http
      ...
      .pipe(
        map((event: HttpEvent<{ data: EvidenciaVerificacionResponseDto }>) => {
  ...
  descargarEvidencia(visitaId: string, evidenciaId: string): Observable<Blob> {
    return this.http.get(
      `${this.apiUrl}/verification-visits/${visitaId}/evidences/${evidenciaId}/download`,
      { responseType: 'blob' },
    );
  }
  ...
  eliminarEvidencia(visitaId: string, evidenciaId: string, lockVersion: number): Observable<void> {
    return this.http.delete<void>(
      `${this.apiUrl}/verification-visits/${visitaId}/evidences/${evidenciaId}`,
      {
  ...
  aplicarCorreccion(
    solicitudId: string,
    req: AplicarCorreccionRequestDto,
  ): Observable<SolicitudDistribuidoraResponseDto> {
    return this.http
      .post<{ data: SolicitudDistribuidoraResponseDto }>(
        `${this.apiUrl}/distributor-applications/${solicitudId}/corrections`,
        req,
      )
      .pipe(map((res) => res.data));
  }
  ...
  finalizarCorrecciones(
    ...
    return this.http
      .post<{ data: SolicitudDistribuidoraResponseDto }>(
        `${this.apiUrl}/distributor-applications/${solicitudId}/corrections/finish`,
        req,
      )
      .pipe(map((res) => res.data));
  }
  ...
  evaluarSolicitud(
    solicitudId: string,
    req: EvaluarSolicitudRequestDto,
  ): Observable<SolicitudDistribuidoraResponseDto> {
    return this.http
      .post<{ data: SolicitudDistribuidoraResponseDto }>(
        `${this.apiUrl}/distributor-applications/${solicitudId}/evaluate`,
        req,
      )
      .pipe(map((res) => res.data));
  }
  ...
  autorizarSolicitud(
    solicitudId: string,
    req: AutorizarSolicitudRequestDto,
  ): Observable<SolicitudDistribuidoraResponseDto> {
    return this.http
      .post<{ data: SolicitudDistribuidoraResponseDto }>(
        `${this.apiUrl}/distributor-applications/${solicitudId}/authorize`,
        req,
      )
      .pipe(map((res) => res.data));
  }
