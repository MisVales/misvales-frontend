...
@Component({
  selector: 'mv-points-contract-status-page',
  ...
  template: `
    <article class="contract-page">
      ...
      <section aria-labelledby="available-heading">
        ...
        <p>
          Los métodos, rutas, parámetros inequívocos, credenciales y cuerpos documentados están
          implementados y cubiertos por pruebas de contrato HTTP.
        </p>
      </section>
...
export class PointsContractStatusPageComponent {
